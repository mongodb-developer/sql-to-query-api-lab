    ...
    <TabItem value="go" label="Go">
      <div>
        ...
        pipeline := mongo.Pipeline{
            {{Key: "$match", Value: bson.D{{Key: "year", Value: bson.D{{Key: "$gt", Value: int32(2000)}}}}}},
            {{Key: "$match", Value: bson.D{{Key: "authors", Value: bson.D{{Key: "$exists", Value: true}}}}}},
            {{Key: "$addFields", Value: bson.D{
                {Key: "numAuthors", Value: bson.D{{Key: "$size", Value: "$authors"}}},
            }}},
            {{Key: "$sort", Value: bson.D{{Key: "numAuthors", Value: -1}}}},
            {{Key: "$limit", Value: 1}},
        }
