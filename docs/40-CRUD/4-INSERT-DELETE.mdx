    ...
    <TabItem value="go" label="Go">
      <div>
        ...
        newReviews := []interface{}{
            bson.D{
                {Key: "text", Value: "Thrilling end."},
                {Key: "rating", Value: int32(4)},
                {Key: "name", Value: "Mark"},
                {Key: "bookId", Value: "0786222727"},
            },
            bson.D{
                {Key: "text", Value: "Must read!"},
                {Key: "rating", Value: int32(5)},
                {Key: "name", Value: "Raj"},
                {Key: "bookId", Value: "0786222727"},
            },
            bson.D{
                {Key: "text", Value: "Very expensive"},
                {Key: "rating", Value: int32(3)},
                {Key: "name", Value: "Yun"},
                {Key: "bookId", Value: "0786222727"},
            },
            bson.D{
                {Key: "text", Value: "Extremely satisfied with the storyline!"},
                {Key: "rating", Value: int32(5)},
                {Key: "name", Value: "Lisa"},
                {Key: "bookId", Value: "0786222727"},
            },
        }
        result, err := reviewsCollection.InsertMany(context.TODO(), newReviews)
        if err != nil {
            log.Fatal(err)
        }
...
<details>
  ...
  <Tabs groupId="challenges" defaultValue={"javascript"}>
    ...
    <TabItem value="go" label="Go">
      <div>
        ```go
        filter := bson.D{{Key: "bookId", Value: "0786222727"}}

        result, err := reviewsCollection.DeleteMany(context.TODO(), filter)
        if err != nil {
            log.Fatal(err)
        }
        fmt.Printf("%d review(s) deleted.\n", result.DeletedCount)
        ```
      </div>
    </TabItem>
  </Tabs>
