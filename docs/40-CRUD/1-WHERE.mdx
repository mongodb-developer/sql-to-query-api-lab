...
<details>
  ...
  <Tabs groupId="challenges" defaultValue={"javascript"}>
    ...
    <TabItem value="csharp" label="C#">
      <div>
        ```csharp
        var booksWithGenreRomanceAndMoreThan300Pages = Builders<Book>.Filter.And(Builders<Book>.Filter.AnyEq(b => b.Genres, "Romance"), Builders<Book>.Filter.Gt(b => b.Pages, 300));

        var filteredBooks = booksCollection
            .Find(booksWithGenreRomanceAndMoreThan300Pages)
            .ToList();
