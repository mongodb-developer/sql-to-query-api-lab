...
<details>
  ...
  <Tabs groupId="challenges" defaultValue={"javascript"}>
    ...
    <TabItem value="go" label="Go">
      <div>
        ```go
        filter := bson.D{{Key: "totalInventory", Value: int32(5)}}
        ...
        for _, book := range results {
            fmt.Printf("Book Title: %s - Total Inventory: %d\n", book.Title, book.TotalInventory)
        }
        ```
      </div>
    </TabItem>
...
<details>
  ...
  <Tabs groupId="challenges" defaultValue={"javascript"}>
    ...
    <TabItem value="go" label="Go">
      <div>
        ```go
        filter := bson.D{{Key: "pages", Value: bson.D{{Key: "$gt", Value: int32(300)}}}}
        ...
        for _, book := range results {
            fmt.Printf("Book Title: %s - Pages: %d\n", book.Title, book.Pages)
        }
        ```
      </div>
    </TabItem>
  ...
  <Tabs groupId="challenges" defaultValue={"javascript"}>
    ...
    <TabItem value="go" label="Go">
      <div>
        ```go
        filter := bson.D{
            {Key: "genres", Value: "Science"},
            {Key: "pages", Value: bson.D{{Key: "$gt", Value: int32(300)}}},
        }
